...
private:
    UINT m_screenWidth = 1800;
    UINT m_screenHeight = 1230;

    UINT m_pondWidth = m_screenWidth;
    UINT m_pondHeightOffset = 30;
    UINT m_pondHeight = m_screenHeight - (m_pondHeightOffset * 2);
